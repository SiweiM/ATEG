...
parser.add_argument("-o", "--out-dir", dest="out_dir_path", type=str, metavar='<str>', required=False,
...
out_dir = '../output/' + args.dataset + '_' + str(args.aspect_size) + '/' + 'fold' + str(args.fold)
U.mkdir_p(out_dir)
U.print_args(args)
...
vocab, train_x, test_x, overall_maxlen = dataset.get_data(data= args.dataset, vocab_size=args.vocab_size, maxlen=args.maxlen,fold=args.fold)
